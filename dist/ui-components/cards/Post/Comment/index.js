...
var _AttachmentRounded = _interopRequireDefault(require("@mui/icons-material/AttachmentRounded"));
var _excluded = ["bug", "label", "name", "required"]; // material-ui
// third-party
// project imports
// assets
...
var Comment = function Comment(_ref3) {
  ...
  var handleChangeReply = function handleChangeReply() {
    setOpenReply(function (prev) {
      return !prev;
    });
  };
  var repliesResult = /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null);
  if (Object.keys(comment).length > 0 && (_comment$data = comment.data) !== null && _comment$data !== void 0 && _comment$data.replies && (_comment$data2 = comment.data) !== null && _comment$data2 !== void 0 && _comment$data2.replies.length) {
    var _comment$data3;
    repliesResult = (_comment$data3 = comment.data) === null || _comment$data3 === void 0 ? void 0 : _comment$data3.replies.map(function (reply, index) {
  ...
  var onSubmit = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(reply) {
      var replyId, newReply;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            handleChangeReply();
            replyId = (0, _uniqueId["default"])('#REPLY_');
            newReply = {
              id: replyId,
              profile: user,
              data: {
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, Object.keys(comment).length > 0 && /*#__PURE__*/_react["default"].createElement(_material.Grid, {
    item: true,
    xs: 12
    ...
    size: "sm",
    alt: "User 1",
    src: comment.profile && comment.profile.avatar && avatarImage("./".concat(comment.profile.avatar))
  })), /*#__PURE__*/_react["default"].createElement(_material.Grid, {
    item: true,
    xs: true,
    zeroMinWidth: true
    ...
    variant: "h5",
    component: "div"
  }, comment.profile.name)), /*#__PURE__*/_react["default"].createElement(_material.Grid, {
    item: true
  }, /*#__PURE__*/_react["default"].createElement(_material.Typography, {
    align: "left",
    variant: "caption"
  ...
  }), ' ', comment.profile.time)))), /*#__PURE__*/_react["default"].createElement(_material.Grid, {
    item: true
    ...
    align: "left",
    variant: "body2"
  }, (_comment$data4 = comment.data) === null || _comment$data4 === void 0 ? void 0 : _comment$data4.comment)), /*#__PURE__*/_react["default"].createElement(_material.Grid, {
    item: true,
    xs: 12
    ...
    onClick: function onClick() {
      return handleCommentLikes(postId, comment.id);
    },
    variant: "text",
    color: "inherit",
    size: "small",
    startIcon: /*#__PURE__*/_react["default"].createElement(_ThumbUpAltTwoTone["default"], {
      color: (_comment$data5 = comment.data) !== null && _comment$data5 !== void 0 && _comment$data5.likes && (_comment$data6 = comment.data) !== null && _comment$data6 !== void 0 && _comment$data6.likes.like ? 'secondary' : 'inherit'
    })
  }, (_comment$data7 = comment.data) !== null && _comment$data7 !== void 0 && _comment$data7.likes && (_comment$data8 = comment.data) !== null && _comment$data8 !== void 0 && _comment$data8.likes.value ? (_comment$data9 = comment.data) === null || _comment$data9 === void 0 ? void 0 : _comment$data9.likes.value : 0, " likes"), /*#__PURE__*/_react["default"].createElement(_material.Button, {
    variant: "text",
  ...
  }, (_comment$data10 = comment.data) !== null && _comment$data10 !== void 0 && _comment$data10.replies ? (_comment$data11 = comment.data) === null || _comment$data11 === void 0 ? void 0 : _comment$data11.replies.length : 0, " reply")))))), repliesResult, /*#__PURE__*/_react["default"].createElement(_material.Collapse, {
    "in": openReply,
    sx: {
      width: '100%'
    }
  }, openReply && /*#__PURE__*/_react["default"].createElement(_material.Grid, {
    item: true,
    xs: 12,
    sx: {
      pl: {
    ...
    InputProps: {
      ...
      startAdornment: /*#__PURE__*/_react["default"].createElement(_material.InputAdornment, {
        position: "start"
      }, /*#__PURE__*/_react["default"].createElement(_AttachmentRounded["default"], {
        fontSize: "small"
      }))
    }
  }))), /*#__PURE__*/_react["default"].createElement(_material.Grid, {
